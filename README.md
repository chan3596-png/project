...
- **BG 분석 종합 보고서**: [`bg_analysis_report.html`](bg_analysis_report.html) (BG 공정의 Crack/TTV 불량 원인 분석, PPTX 주장 교차 검증, Base64 시각화 및 MathJax 적용 리포트)
...
- **BG 불량 분석 스킬**: [`.agents/skills/bg-ooc-analysis/SKILL.md`](.agents/skills/bg-ooc-analysis/SKILL.md) (BG 공정 특화 물리적 해석, 공선성 검증, PPTX 타당성 검토 워크플로우)
